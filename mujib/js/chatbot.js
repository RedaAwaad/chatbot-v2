$(document).ready(function () {
  ...
  function loadWelcomeMessage() {
    ...
    audio.src = "/assets/tones/robot_transform.mp3";

    setTimeout(function () {

      $(".chatbot__welcome").addClass('show-welcome');
      $(".chatbox__open--box img").addClass('shake');
      // audio.play();
    }, 1500);
  }
  ...
  $(".chatbox__open--box").on("click", function () {
    $(".chatbot__welcome").removeClass('show-welcome');
    $(".chatbox__open--box img").removeClass('shake');
  });

  // Init Simple Scroll Plugin ==============
  new SimpleBar($("#chatbotScroll")[0], $('body'));
