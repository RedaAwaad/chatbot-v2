...
@endpush
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
            <h2><i class="fa fa-answers"></i> {{ __('backend/answers.title') }}<small>{{ __('backend/answers.desc') }}</small></h2>
            <a href="{{ route('answers.create') }}" class="btn btn-primary "style="float: right"> New answer</a>
