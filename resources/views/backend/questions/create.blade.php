...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <form id="demo-form" method="POST" action="{{route('questions.store')}}">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <label for="text">{{ __('backend/questions.text') }} * :</label>
                <input type="text" id="text" value="{{ old('text') }}" class="form-control  @error('text') is-invalid @enderror" name="text" />
                @error('text')
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="text" value="{{ old('text_ar') }}" class="form-control  @error('text_ar') is-invalid @enderror" name="text_ar" />
                @error('text_ar')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <input type="text" id="num_answer" value="{{ old('num_answer') }}"  class="form-control  @error('num_answer') is-invalid @enderror" name="num_answer"  />
        @error('num_answer')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <p>
            true:
            <input type="radio" class="flat" name="is_entry_point" id="is_entry_pointM" value="1"   /> False:
            <input type="radio" class="flat" name="is_entry_point" id="is_entry_pointF" value="0" checked="" />
        </p>
            <br />
