...
<head>
    ...
    <title>Ministry of Civil Service</title>
    <link rel="icon" href='{{url('/front/themes/civil/')}}/images/favicon.ico ' type='image/x-icon' />
    <link href="https://fonts.googleapis.com/css?family=Cairo&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    @if(Session::get('locale') == 'en')
        <link rel="stylesheet" type="text/css" href="{{url('/front/themes/civil/')}}/css/main.css">
    @else
        <link rel="stylesheet" type="text/css" href="{{url('/front/themes/civil/')}}/css/main.css">
...
<nav class="navbar py-4">
    <div class="container">
        <div class="brand-name">
            <a href="#"><img src="{{url('/front/themes/civil/')}}/images/mcs_Logo.svg" width="160" height="36" alt="saudia"></a>
        </div>
        <div class="languages">
            <a href="{{url('/front/themes/civil/')}}/stat/stat.html" class="d-block d-sm-inline-block mb-1 mb-sm-0 text-decoration-none mx-2">
        ...
        <div class="header-content">
            <div class="row">
                <div class="robot-img col-md-4 offset-md-1 text-center d-inline-block d-md-none">
                    <img src="{{url('/front/themes/civil/')}}/images/chatbot-svg.svg" class="robot-vector" alt="SAUDIA, Book Flights, Hotels, Holidays Packages">
                </div>
                <div class="col-md-7">
                    <div class="hero-text">
                        <h1>Ministry of Civil Service with Excellent AI Customer Service.</h1>
                        <!-- <p class="lead mt-4"></p> -->
                        <div class="chat-box d-inline-block shadow">
                <span class="d-inline-block chat-btn" id="chatting-btn">
                  <img src="{{url('/front/themes/civil/')}}/images/chat-icon.png" width="20" height="20" alt="SAUDIA, Book Flights, Hotels, Holidays Packages">
                </span>
                        </div>
          ...
          <span class="exit-chatting-box" id="close-chatting">
            <i class="fas fa-times" ></i>
                ...
                <div class="chatting-header d-flex align-items-center justify-content-between px-2 py-1">
                    <div>
                        <img src="{{url('/front/themes/civil/')}}/images/chatbot-svg.svg" class="robot-icon" width="40" height="50" alt="chatbot">
                ...
                <div class="chatting-content">
                    ...
                    <div class="intro-img">
                        <img src="{{url('/front/themes/civil/')}}/images/intro.jpg" width="100%" height="100%" alt="intro-img">
                    </div>
                ...
                <div class="typing-text py-2 px-3 shadow">
                    <form action="#" id="sendMessage">
                        ...
                        <button type="submit" class="send-message-button" ><img src="{{url('/front/themes/civil/')}}/images/send.png" class="send-message mx-2 mb-1" width="35" alt="send message"></button>
                    </form>
                </div>
            </div>
        </div>
...
<script src="{{url('/front/themes/civil/')}}/js/jquery-3.4.1.min.js"></script>
<script>
    var user_id = "{{$user->id}}"
