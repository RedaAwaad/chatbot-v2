...
<head>
    ...
    <title>Munawla</title>
    <link rel="icon" href='{{url('/front/themes/munawla/')}}/images/fav-icon.png' type='image/x-icon' />
    ...
    <nav class="navbar py-4">
        <div class="container">
            <div class="brand-name">
                <a href="#"><img src="{{url('/front/themes/munawla/')}}/images/munawla-logo.png" width="160" height="36"
                        alt="saudia"></a>
            </div>
            <div class="languages">
                <a href="{{url('/front/themes/munawla/')}}/stat/stat.html"
                    class="d-block d-sm-inline-block mb-1 mb-sm-0 text-decoration-none mx-2">
                    Statistics <i class="fas fa-chart-line fa-lg"></i>
                </a>
                <a href="{{ Session::get('locale') == 'en' ? '/public/chatbot/lang/ar' : '/public/chatbot/lang/en' }}"
    ...
    <main class="main-header">
        ...
        <div class="container">
            <ul class="social-media list-unstyled m-0 p-0 d-flex ">
                ...
                <li>
                    <a href="https://www.instagram.com/20express/" class="social-icon d-inline-block shadow"
                        target="_blank">
            ...
            <div class="header-content">
                <div class="row">
                    <div class="robot-img col-md-4 offset-md-1 text-center d-inline-block d-md-none">
                        <img src="{{url('/front/themes/munawla/')}}/images/chatbot-svg.svg" class="robot-vector"
                            alt="SAUDIA, Book Flights, Hotels, Holidays Packages">
                    </div>
                    <div class="col-md-7">
                        <div class="hero-text">
                            <h1>Make Air Transportation For you Easier with Excellent AI Customer Service.</h1>
                            <!-- <p class="lead mt-4"></p> -->
                            <div class="chat-box d-inline-block shadow">
                                <span class="d-inline-block chat-btn" id="chatting-btn">
                                    <img src="{{url('/front/themes/munawla/')}}/images/chat-icon.png" width="20"
                                        height="20" alt="SAUDIA, Book Flights, Hotels, Holidays Packages">
                                </span>
                            </div>
                ...
                <div class="robot-chatting-container shadow">
                    ...
                    <div class="chatting-header d-flex align-items-center justify-content-between px-2 py-1">
                        <div>
                            <img src="{{url('/front/themes/munawla/')}}/images/chatbot-svg.svg" class="robot-icon"
                                width="40" height="50" alt="chatbot">
                    ...
                    <div class="chatting-content">
                        <div class="identity py-2 text-center text-dark">Welcome to Munawla</div>
                        <div class="intro-img">
                            <img src="{{url('/front/themes/munawla/')}}/images/intro.jpg" width="100%" height="100%"
                                alt="intro-img">
                        </div>
                    ...
                    <div class="typing-text py-2 px-3 shadow">
                        <form action="#" id="sendMessage">
                            ...
                            <button type="submit" class="send-message-button"><img
                                    src="{{url('/front/themes/munawla/')}}/images/send.png"
                                    class="send-message mx-2 mb-1" width="35" alt="send message"></button>
                        </form>
                    </div>
                </div>
            </div>
