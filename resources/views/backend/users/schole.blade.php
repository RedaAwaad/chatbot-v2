...
<head>
    ...
    <title>Chatbot | {{$setting->website_name}}</title>
    ...
    <style>
        .main-header {
            position: relative;
            height: calc(100vh);
            background: url("{{url($setting->picture)}}") no-repeat center;
...
<nav class="navbar py-4">
    <div class="container">
        <div class="brand-name">
            <a href="#"><img src="{{url($setting->logo)}}" width="200" height="60" alt="saudia"></a>
        </div>
        <div class="languages">
            <a href="{{ Session::get('locale') == 'en' ? '/chatbot/lang/ar' : '/chatbot/lang/en' }}" class="d-inline-block text-decoration-none mx-2">
