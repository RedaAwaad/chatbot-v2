...
<head>
    ...
    <title>Chatbot | {{$chat->user->setting->website_name}}</title>
    <link rel="icon" href='{{url($chat->user->setting->icon)}}' type='image/x-icon' />
    ...
    <style>
        .main-header {
            position: relative;
            height: calc(100vh);
            background: url("{{url($chat->user->setting->picture)}}") no-repeat center;
...
<nav class="navbar py-4">
    <div class="container">
        <div class="brand-name">
            <a href="#"><img src="{{url($chat->user->setting->logo)}}" width="200" height="60" alt="saudia"></a>
        </div>
        <div class="languages">
            <a href="{{ Session::get('locale') == 'en' ? route('lang','ar') : route('lang','en') }}" class="d-inline-block text-decoration-none mx-2">
...
<main class="main-header">
    ...
    <div class="container">
        <ul class="social-media list-unstyled m-0 p-0 d-flex ">
            <li><a href="{{$chat->user->setting->fb}}" class="social-icon d-inline-block shadow" target="_blank">
                    <i class="fab fa-facebook-square fa-lg"></i>
                </a>
            </li>
            <li>
                <a href="{{$chat->user->setting->tw}}" class="social-icon d-inline-block shadow mx-3" target="_blank">
                    <i class="fab fa-twitter fa-lg"></i>
                </a>
            </li>
            <li>
                <a href="{{$chat->user->setting->ln}}" class="social-icon d-inline-block shadow" target="_blank">
        ...
        <div class="header-content">
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="hero-text">
                        <h1>{{$chat->user->setting->description}}</h1>
                        <!-- <p class="lead mt-4"></p> -->

                    </div>
                </div>
                <div class="robot-img col-md-4 offset-md-1 text-center d-none d-md-inline-block">
                    <img src="{{url($chat->user->setting->icon)}}" class="robot-vector" alt="SAUDIA, Book Flights, Hotels, Holidays Packages">
                </div>
            </div>
        </div>
    </div>
