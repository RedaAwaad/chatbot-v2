...
<nav class="navbar py-4">
    <div class="container">
        <div class="brand-name">
            <a href="#"><img src="{{url('/front/themes/munawla/')}}/images/munawla-logo.png" width="160" height="36" alt="saudia"></a>
        </div>
        <div class="languages">
            <a href="{{url('/front/themes/munawla/')}}/stat/stat.html" class="d-block d-sm-inline-block mb-1 mb-sm-0 text-decoration-none mx-2">
...
<main class="main-header">
    ...
    <div class="container">
        <ul class="social-media list-unstyled m-0 p-0 d-flex ">
            ...
            <li>
                <a href="https://www.instagram.com/20express/" class="social-icon d-inline-block shadow" target="_blank">
          ...
          <span class="exit-chatting-box" id="close-chatting">
            <i class="fas fa-times" ></i>
                ...
                <div class="chatting-content">
                    ...
                    <div class="intro-img">
                        <img src="{{url('/front/themes/munawla/')}}/images/intro.jpg" width="100%" height="100%" alt="intro-img">
                    </div>
