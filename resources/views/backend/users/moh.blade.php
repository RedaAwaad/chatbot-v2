...
<head>
    ...
    <link rel="stylesheet" href="{{url('health')}}/css/all.min.css">
    <link rel="stylesheet" href="{{url('health')}}/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('health')}}/css/main.css">
    ...
    <div class="container">
        <div class="brand-name">
            <a href="#" class="main-logo">
                <img src="{{url('health')}}/images/logo.svg" width="160" alt="Ministry of Health">
            </a>
        </div>
        <div></div>
        <div class="languages">
            <a href="#" class="d-inline-block text-decoration-none mx-2">
                Arabic <i class="fas fa-language fa-lg"></i>
            </a>
        </div>
    </div>
</nav>
<main class="main-header">
    ...
    <div class="container">
        <ul class="social-media list-unstyled d-flex justify-content-center align-items-center">
            <li >
                <a href="#" class="social-icon d-inline-block mx-2">
            ...
            <li><a href="#" class="social-icon d-inline-block mx-2">
        ...
        <div class="header-content">
            <div class="row">
                <div class="col-md-7 order-2 order-md-1">
                    <div class="hero-text">
                        <h1>Chatbot Coronavirus Check Online.</h1>
                        <p>Check your symptoms and get to know if you need to contact a doctor now.</p>
                    </div>
                </div>
                <div class="robot-img col-md-5 text-center order-1">
                    <img src="{{url('health')}}/images/chatbot_vector.svg" class="robot-vector" alt="MINISTRY OF HEALTH">
                </div>
            </div>
        </div>
    </div>
</main>
<script src="{{url('health')}}/js/jquery-3.4.1.min.js"></script>
<script src="{{url('health')}}/js/bootstrap.min.js" ></script>
<script>
    var user_id = "{{$user->id}}"
